...
import org.knime.expressions.util.ExpressionPanelFactory;
...
final class EditDialog extends JDialog {
	...
	private final DeriveFieldNodeDialog m_parent;
	 ...
	 */
	public EditDialog(DeriveFieldNodeDialog parent) {
		m_parent = parent;
		...
		/*
		 * Ensure that the parent dialog can re-enable its focus when exit button is
		 * clicked.
		 */
		...
		/* TODO: alwaysontop - disable if other program has focus. 
		 * May be achievable by using an own thread pushing the dialog to the front.*/
	 ...
	 * 
	 * @param specs data table spec of the input table
	 * @param flowVariables map containing all available flow variables
	 */
